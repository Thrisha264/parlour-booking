...
export class Backend implements backendInterface {
    ...
    async createBooking(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAvailableTimeSlots(arg0: bigint, arg1: string): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async seedServices(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedServices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateService(arg0: bigint, arg1: string, arg2: string, arg3: bigint, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
